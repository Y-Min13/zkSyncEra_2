...
exc_remains = [0.00003, 0.00004]  # Остаток на кошельке при переводе на адрес биржи и бридже (ETH)
...
modules.extend([
    ...
    SM2('sm2_2', 0, 1, 3, 1, 2, 1, 2),
    SM1('sm1_1', 1, 2, 1, 2, 1, 2),
])
modules_shuffle = 1  # Перемешать порядок модулей? 1 - да, 0 - нет

modules_min = 1  # Минимальное количество модулей для кошелька
modules_max = 1  # Максимальное количество модулей для кошелька
...
bridge_module = 1  # Выбор бриджа: 0 - случайный, 1 - Orbiter, 2 - Sync
